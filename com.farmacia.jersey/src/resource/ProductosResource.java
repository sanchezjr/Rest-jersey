...
public class ProductosResource {
	...
	// Allows to insert contextual objects into the class,
	  ...
	  // Use http://localhost:8080/com.vogella.jersey.todo/rest/productos/count
	  ...
	  // Allows to type http://localhost:8080/com.vogella.jersey.todo/rest/productos/1
	  // 1 will be treaded as parameter todo and passed to ProductoResource
	  @Path("{todo}")
	  public ProductoResource getProducto(@PathParam("todo") String id) {
